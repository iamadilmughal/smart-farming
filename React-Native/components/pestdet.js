...
loadAsyncData = async () => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <MyHeader title="Pest Detection" color={a} isHome={true} navigation={this.props.navigation}/>
  ...
  <Button rounded style={{width:140,alignItems:'center',marginLeft:20,backgroundColor:'#006400'}} onPress={()=>this.props.navigation.navigate('UploadPest')}>
